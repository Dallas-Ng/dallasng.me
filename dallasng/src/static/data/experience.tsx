...
export const experience = [
	...
	},
	{
		...
		description: [
			<Text>
				<strong>Developed over 8 websites</strong> used in team-competitions,
				proof of concepts for businesses and personal portfolios
			</Text>,
			<Text>
			...
			<Text>
				<strong>Built wireframes and prototypes</strong> of the applications
			</Text>
		],
		technologies: [
			'React',
