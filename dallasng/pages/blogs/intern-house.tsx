...
const BlogPage: NextPage = () => (
	<BlogLayout meta={meta}>
		...
		<Text mb="md">
			...
			help others to build their portfolios. Together with 3 software engineers
			based in Canada, India and the United States, we met online on a discord
			channel and started this project.{' '}
			<Anchor href="https://intern.house" target="_blank">
				intern.house
			</Anchor>{' '}
			is a platform for interns to find accommodations from other interns in the
			United States.
		</Text>
		...
		<Text mb="md">
			Commonly, interns would travel to other states to do their internships for
			up to 2-3 months. This meant that they would leave their rooms/houses
			vacant for that period of time. This prompted the idea; What if other
			interns would sublet from those interns working cross borders? During the
			period of internships, this creates a piggy-back network effect amongst
			each other.
		</Text>
		...
		<Text mb="md">
			...
			community. The vision for the platform was to create a network for interns
			to develop further in their careers.
		</Text>

		<Text mb="md">
			We targeted 2 main areas; accommodations and networking. Accommodation is
			as straightforward as something like Airbnb, we would help collate housing
			listings from various sources to build an all-in-one platform. Networking
			would be creating discussion forums, showing industry events and thus
			creating a social network for intern
		</Text>
		...
		<Text mb="md">
			My assumption was if I was a university student, I would be more trusting
			to another university student, especially if that student was in the same
			field such as software engineering. We could get off on the right foot and
		...
		<Text mb="md">
			...
			for community and also agreed that they felt more comfortable if they met
			up with someone of the same interest.
		</Text>
		...
		<Text mb="md">
			We quickly sprung into action, we distributed our roles and tasks and set
			up communications using Discord. As we lived in different timezones, we
			needed to agree on certain timeframes and processes that allowed us to
		...
		<Text mb="md">
			On the front end would be me designing the wireframes and with the help of
			another developer translate it into React. Our main focus for the web app
			initially was to set up the email collection landing page, running ads to
			it to gauge interest. On the backend, it was a Node.js api server and
			python scripts running on lambda functions.
		</Text>
		...
		<Text mb="md">
			The initial project development was gung-ho, this meant that any idea that
			could fly would be built. While this was exciting to have this also
			derailed timelines and leads to less fully-built out features. To solve
			this, we started to use Trello, a kanban board where each developer would
			see the tickets they owned and any additional information they needed. To
			create additional features, we would impose a “put it in a chat and
			let&apos;s think about it” mentality so that not all features would
		...
		<Text mb="md">
			<strong>Project Management</strong>; As a rule of thumb, I broke down big
			features into smaller features where each developer could have 1 main
			focus. It is very easy for me to just tell someone to “build the login
			system” but that wouldn&apos;t be beneficial as they might get lost along
			the way or just be overwhelmed with what to do.
		</Text>
		...
		<Text mb="md">
			...
			industry. At least in the school I went to, my teacher focused more on the
			end result than the actual code that was being written.
		</Text>
		...
		<ul>
			...
			<li>
				Others: Things that are related but not directly related to the problem
				or solution
			</li>
		</ul>
		...
		<Text mb="md">
			Another method I tried was pair-coding, we would hop on discord and screen
			share about the feature that was being built. This method was very
			insightful for both sides, it allowed me to see the main struggles of
			building the features while the other side was able to clarify on the spot
			about anything. While this was a good method, it was also very
		...
		<Text mb="md">
			...
			my full-time job. However, I still kept in touch with the development team
			in case of any problems and pitched in occasionally.
		</Text>
		...
		<Text mb="md">
			The project was definitely something eye-opening for me, it was the spark
			that started my love for startups and made me want to build my own
		...
		<Text mb="md">
			Even though the project never reached completion, the learning process for
			everyone was monumental. My team used the experience to apply for
